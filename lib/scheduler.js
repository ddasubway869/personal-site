  ...
  for (const member of members) {
    ...
    try {
      await mailer.sendMail({
        ...
        text:    `Hey ${name},\n\nWeek ${weekNum} is here. What are you listening to?\n\nWhat are you listening to this week, ${name}? Submit your pick and see what the community is into.\n\nThank you for being part of this. On behalf of the ARVL team, we appreciate every single one of you who shows up each week.\n\n→ ${BASE_URL}\n${unsubscribeUrl ? `\nUnsubscribe: ${unsubscribeUrl}` : ''}`,
        html:    buildEmail({
          eyebrow:  'Weekly pick',
          heading:  `Week ${weekNum} is open.`,
          body:     `What are you listening to this week, ${name}? Submit your pick and see what the community is into.<br><br>Thank you for being part of this. On behalf of the ARVL team, we appreciate every single one of you who shows up each week.`,
